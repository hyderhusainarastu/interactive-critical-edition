 ...
 *
 * Kept dependency-free and pure so it's directly vitest-able without a
 * renderer, per the project's own convention (camera/cameraMath.ts).
 */
 ...
 * input. Duplicated (not imported) from src/bench/runner.ts deliberately —
 * that module belongs to the bench harness, not to a single prototype, and
 * this file must stay a self-contained, zero-dependency unit. */
 ...
 * links (charter's "visibleDegree", distinct from the fixture's static
