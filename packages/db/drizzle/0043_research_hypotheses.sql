...
ALTER TABLE "research_revision" ADD CONSTRAINT "research_revision_typed_target" CHECK (("research_revision"."object_type" = 'claim' AND "research_revision"."research_claim_id" IS NOT NULL AND "research_revision"."claim_relationship_id" IS NULL AND "research_revision"."debate_cluster_id" IS NULL AND "research_revision"."research_hypothesis_id" IS NULL AND "research_revision"."research_gap_id" IS NULL)
        OR ("research_revision"."object_type" = 'relationship' AND "research_revision"."claim_relationship_id" IS NOT NULL AND "research_revision"."research_claim_id" IS NULL AND "research_revision"."debate_cluster_id" IS NULL AND "research_revision"."research_hypothesis_id" IS NULL AND "research_revision"."research_gap_id" IS NULL)
        OR ("research_revision"."object_type" = 'cluster' AND "research_revision"."debate_cluster_id" IS NOT NULL AND "research_revision"."research_claim_id" IS NULL AND "research_revision"."claim_relationship_id" IS NULL AND "research_revision"."research_hypothesis_id" IS NULL AND "research_revision"."research_gap_id" IS NULL)
        OR ("research_revision"."object_type" = 'hypothesis' AND "research_revision"."research_hypothesis_id" IS NOT NULL AND "research_revision"."research_claim_id" IS NULL AND "research_revision"."claim_relationship_id" IS NULL AND "research_revision"."debate_cluster_id" IS NULL AND "research_revision"."research_gap_id" IS NULL)
        OR ("research_revision"."object_type" = 'gap' AND "research_revision"."research_gap_id" IS NOT NULL AND "research_revision"."research_claim_id" IS NULL AND "research_revision"."claim_relationship_id" IS NULL AND "research_revision"."debate_cluster_id" IS NULL AND "research_revision"."research_hypothesis_id" IS NULL)
        OR ("research_revision"."object_type" NOT IN ('claim', 'relationship', 'cluster', 'hypothesis', 'gap') AND "research_revision"."research_claim_id" IS NULL AND "research_revision"."claim_relationship_id" IS NULL AND "research_revision"."debate_cluster_id" IS NULL AND "research_revision"."research_hypothesis_id" IS NULL AND "research_revision"."research_gap_id" IS NULL));