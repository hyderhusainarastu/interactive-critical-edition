...
**Candidate:** `2c0f820`. The retained preparation comparison found no removed
...
| --- | --- | --- |
| Auth, onboarding, upload, duplicate/confirmation/retry, Trash | Preserved route/workflow surface in the integrated tree | **PENDING J01 re-run** after parallel repair |
...
| Writer projects/documents/autosave/citations/export | Preserved; focused panels and insertion affordances integrated | **PENDING J07 re-run** after parallel repair |
...
must not be used to waive J01, J07, the remaining journeys, or the manual
