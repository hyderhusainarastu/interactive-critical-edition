      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12">
        ...
        <div className="mt-8 flex flex-col gap-6 text-[var(--color-text)]">
          <Section title="What we store">
            ...
            corrections you make to AI annotations. Preferences such as your expertise level are stored to
          ...
          <Section title="AI handling">
            ...
            model. When an AI model is used to classify how references relate to a text, calls go to the provider&rsquo;s
            API tier under its data-use terms. Your uploaded content is never used to train models without your
            explicit, separate opt-in — the default is opt-out.
          </Section>
          ...
          <Section title="A research aid, not settled scholarship">
            Every AI-generated claim carries a confidence and its provenance. Verify against the primary text before
            relying on anything; you can correct, dispute, or hide any AI annotation.
          </Section>
        </div>
      </main>
      <SiteFooter />
