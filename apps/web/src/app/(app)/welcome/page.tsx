...
/**
 * Short, optional onboarding (plan §23 Phase 6): asks for an expertise
 * level (which seeds the roadmap's default) and nudges toward a first
 * upload. Everything here is skippable — it never blocks getting into the
 * product. The dashboard routes new users here until `onboardedAt` is set.
 */
const LEVELS: { value: string; label: string; blurb: string }[] = [
  ...
  { value: "intermediate", label: "Some background", blurb: "A balanced roadmap with useful context." },
  { value: "advanced", label: "Working researcher", blurb: "The full picture — context, comparisons, and all." },
];
